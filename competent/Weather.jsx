...
console.log(data)
  return (
    <div  className='relative flex flex-col justify-between max-w-[500px] w-full h-[90vh] m-auto p-4 text-gray-300 z-10  ' >
      ...
      <div  className='bg-black/30 relative  rounded-xl top-10 ' >
        <p  className='text-2xl text-center  ' >Weather in {data.name}</p>
        <div   className='flex justify-between text-center  ' >
            <div>
          <p  className='font-bold  text-white text-2xl' >{data.main.feels_like.toFixed(0)}°</p>
